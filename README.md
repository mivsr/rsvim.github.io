...
- To sync API docs from [rsvim](https://github.com/mivsr/rsvim), please follow below steps:
  1. Clone [rsvim](https://github.com/mivsr/rsvim) repo in the sibling directory under the same parent directory as _this_ repo.
